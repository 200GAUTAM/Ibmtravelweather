    ...
    <body>
            ...
            <section class="tp-banner-container">
                ...
                <div class="tp-banner" >
                    ...
                    <ul> 
                        ...
                        <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
                            <!-- MAIN IMAGE -->
                            <img src="img/slide/2.jpg"  alt="fullslide1" data-bgposition="top center" data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130" data-bgfitend="100" data-bgpositionend="right center">
                            <!-- LAYERS -->
                        </li>
                        ...
                        <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
                            <!-- MAIN IMAGE -->
                            <img src="img/slide/3.jpg"  alt="fullslide1" data-bgposition="right center" data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130" data-bgfitend="100" data-bgpositionend="right center">
                            <!-- LAYERS -->
                        </li>
                        ...
                        <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
                            <!-- MAIN IMAGE -->
                            <img src="img/slide/4.jpg"  alt="fullslide1" data-bgposition="left center" data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130" data-bgfitend="100" data-bgpositionend="right center">
                            <!-- LAYERS -->
                        </li>
                    </ul> 
                    <!-- END SLIDES  --> 
                ...
                <div class="filter-title">
                    ...
                    <div class="title-header">
                        <h1>#Digital WordRobe</h1>
                        <p class="lead">Finds what to carry along ....!</p>
                    </div>
                    <!-- END TITLE HEADER-->
		...
		<div id="form-content">
                    <div class="filter-header">
                        <form  id="kl" method = "post">
                            <input type="text" required="required" placeholder="Where do you want to go?" class="input-large" name ="city" id="autocomplete" onFocus="geolocate()">
                            <input type="text" required="required" placeholder="Check In" class="date-input" id="lat" name="x">
                            <input type="text" required="required" placeholder="Check Out" class="date-input" id="lng" name="y">
                            <div class="selector">
                                <select class="guests-input" name="offset">
                                    <option value="1">only 6 day prediction</option>
                                    <option value="3">3rd day from now</option>
                                    <option value="4">4th day from now</option>
                                    <option value="5">5th day from now</option>
                                    <option value="6">6th day from now</option>
                                </select>
                                <span class="custom-select">i'll be there </span>
                            </div>
...
$(document).ready(function() {	
	...
	$('#kl').submit(function(e){
		...
		.done(function(data){
			$('#new-content').fadeIn('slow').html(data);
